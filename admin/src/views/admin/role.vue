  ...
  export default {
    ...
    methods: {
      ...
      list(page) {
        let _this = this;
        Loading.show();
        _this.$ajax.post('http://127.0.0.1:9000/system/admin/role/query.do', {
          page: page,
      ...
      listUser() {
        let _this = this;
        _this.$ajax.post('http://127.0.0.1:9000/system/admin/user/query.do', {
          page: 1,
          size: 9999
        }).then((response)=>{
          let resp = response.data;
      ...
      listRoleUser() {
        let _this = this;
        _this.roleUsers = [];
        _this.$ajax.get( 'http://127.0.0.1:9000/system/admin/role/list-user/' + _this.role.id).then((res)=>{
          let response = res.data;
